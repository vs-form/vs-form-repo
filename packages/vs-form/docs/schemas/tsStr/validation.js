...
const validation = `import { ISchemaDesign, Component, ButtonAction, DataType, ValidationMethod } from '@vs-form/vs-form'
    ...
    radioValMethod: {
      ...
      data: {
        ...
        onChange(p) {
          ...
          } else { p.schema.validationMethod = ValidationMethod.validateOnSubmit }
