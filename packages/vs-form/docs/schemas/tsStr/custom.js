...
const custom = `import { ISchemaDesign, Component, registerCustomComponent, DataType, types } from '@vs-form/vs-form'
...
const schema: ISchemaDesign = {
  onActionClick: (num: number, p: types.IComponentEventParams) => {
    const txt = p.schema.components.sdtext as types.IComponentText
      ...
      actions: [
        {
          ...
          tooltip: 'bishop',
          onClick: (p: types.IComponentEventParams) => p.schema.onActionClick(1, p)
        },
        {
          ...
          tooltip: 'pawn',
          onClick: (p: types.IComponentEventParams) => p.schema.onActionClick(2, p)
        },
        {
          ...
          tooltip: 'queen',
          onClick: (p: types.IComponentEventParams) => p.schema.onActionClick(3, p)
        },
