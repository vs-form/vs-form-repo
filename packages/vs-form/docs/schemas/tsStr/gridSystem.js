...
const gridSystem = `import { ISchemaDesign, Component, DataType, types } from '@vs-form/vs-form'

import { set } from '@vs-form/vs-form'

const applyGridContainerProp = (prop: string, p: types.IDataEventParams) => {
...
const schema: ISchemaDesign = {
  ...
  onChange(p) {
    const textContainer = p.schema.components.textContainer as types.IComponentText
    const textChild = p.schema.components.textChild as types.IComponentText
    const pn = p.schema.components.panel1 as types.IComponentPanel
  ...
  components: {
    ...
    itemsWidth: {
      ...
      data: {
        ...
        default: 'auto',
        onChange(p) {
          const pn1 = p.schema.components.panel1 as types.IComponentPanel
          const pn2 = p.schema.components.panel2 as types.IComponentPanel
